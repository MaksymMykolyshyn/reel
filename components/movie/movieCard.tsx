...
export function MovieCard({
  ...
  return (
    <div className="w-full max-w-80 border border-primary p-4 flex flex-col transition hover:border-accent text-left">
      ...
      <button onClick={() => router.push(`/movie/${movie.id}`)}>
        <Image
          ...
          width={500}
          height={750}
          className="w-full h-100 object-cover border border-primary"
        />
      </button>
      {showReleaseDate && (
